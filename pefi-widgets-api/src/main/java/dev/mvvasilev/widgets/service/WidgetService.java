package dev.mvvasilev.widgets.service;

import dev.mvvasilev.common.exceptions.CommonFinancesException;
import dev.mvvasilev.widgets.dtos.CreateUpdateWidgetDTO;
import dev.mvvasilev.widgets.dtos.CreateWidgetParameterDTO;
import dev.mvvasilev.widgets.dtos.WidgetDTO;
import dev.mvvasilev.widgets.dtos.WidgetParameterDTO;
import dev.mvvasilev.widgets.entity.Widget;
import dev.mvvasilev.widgets.entity.WidgetParameter;
import dev.mvvasilev.widgets.persistence.WidgetParameterRepository;
import dev.mvvasilev.widgets.persistence.WidgetRepository;
